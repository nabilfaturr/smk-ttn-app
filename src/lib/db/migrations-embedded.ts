...
`,
  ...
  {
    name: "0002_real_wolverine",
    sql: `ALTER TABLE \`tahun_ajaran\` ADD \`tanggal_mulai\` text DEFAULT '1900-01-01' NOT NULL;--> statement-breakpoint
ALTER TABLE \`tahun_ajaran\` ADD \`tanggal_selesai\` text DEFAULT '1900-01-01' NOT NULL;`,
  },
]
